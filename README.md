...
- download the [.JAR file](https://github.com/DynamiteBob17/Mandelbrot-Set-Viewer/raw/main/target/MandelbrotSetViewer.jar) located in the "target" directory and run it  
**OR**
